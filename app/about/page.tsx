export default function AboutPage() {
  return (
    <>
      <h1 className="text-4xl font-bold mb-8 text-teal-400">About Automation Consulting LLC</h1>
      <p className="text-xl mb-6 text-white">
        Automation Consulting LLC is a leading provider of custom financial dashboards and automation solutions. We empower businesses to make data-driven decisions with ease and efficiency.
      </p>
      <div className="space-y-6 text-gray-300">
        <p>
          Automation Consulting LLC is at the forefront of financial technology, specializing in custom dashboard solutions that empower businesses to make data-driven decisions with ease and confidence.
        </p>
        <p>
        ...
        <p>
          To democratize financial intelligence by providing businesses with tailored, easy-to-use dashboard solutions that drive growth, efficiency, and informed decision-making.
        </p>
        <h3 className="text-2xl font-bold mt-8 mb-4 text-teal-400">Why Choose Us?</h3>
        <ul className="list-disc list-inside space-y-2">
          <li>Customized Solutions: No two businesses are alike, and neither are our dashboards.</li>
